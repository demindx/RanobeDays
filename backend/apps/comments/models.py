...
class Comment(BaseModel):
    TYPES = (("novel", "Novel"), ("chapter", "Chapter"))
    ...
    novel = models.ForeignKey(
        "novels.Novel", null=True, blank=True, on_delete=models.CASCADE
    )
    chapter = models.ForeignKey(
        "chapters.Chapter", null=True, blank=True, on_delete=models.CASCADE
    )
